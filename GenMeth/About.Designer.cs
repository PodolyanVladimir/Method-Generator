...
namespace GenMeth
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBox1.Size = new System.Drawing.Size(664, 339);
			...
			this.label1.Text = "Генератор методов создания объектов \r\nлокального представления данных";
			...
			this.label2.Text = "Дипломный проект студента\r\nГАПОУ АО \"Вельский индустриально-экономический колледж" +
			"\"\r\nПодолян Владимира Андреевича\r\nВельск 2018";
			...
			this.Click += new System.EventHandler(this.AboutClick);
